...
import id.robby.fatah.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var binding: id.robby.fatah.databinding.ActivityMainBinding
